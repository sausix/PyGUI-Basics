...
from PySide6.QtCore import QSettings, QSize, Qt, QDateTime, Signal, QMetaObject, QByteArray
                ...
                if "isfloating" in value:
                    ...
                    if isfloating:
                        ...
                        if "docklocation" in value:
                            ...
                            if loc:
                                window.addDockWidget(dw_int_to_area.get(loc, Qt.DockWidgetArea.NoDockWidgetArea), widget)
